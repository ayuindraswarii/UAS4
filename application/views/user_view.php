	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo base_url();?>index.php/Template"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Data User</h3>
					        <a href="<?php echo base_url();?>index.php/User/tambah" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
					         <a href="<?php echo base_url();?>index.php/Pdfusr" class="btn btn-primary" style="float:right;"><span class="glyphicon glyphicon-print"></span> Cetak</a>
						</div>
								...
								<div class="col-md-12">
									<table class="table table-hover">
					                  ...
					                  <tbody>
					                    ...
					                    <tr>
					                      <th scope="row"><?php echo $usr->kode_user; ?></th>
					                      <td><?php echo $usr->nama_user; ?></td>
					                      <td><?php echo $usr->username_user; ?></td>
					                      <td><?php echo $usr->password_user; ?></td>
					                      <td>
					                        <a href="<?php echo base_url();?>index.php/user/ubah/<?php echo $usr->kode_user;?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
					                        <a href="<?php echo base_url();?>index.php/user/hapus/<?php echo $usr->kode_user;?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger">
