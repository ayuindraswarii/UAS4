			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?php echo base_url();?>index.php/Peserta" class="active"><i class="lnr lnr-users"></i> <span>Peserta</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Data Peserta</h3>
					        <a href="<?php echo base_url();?>index.php/Peserta/tambah" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
					         <a href="<?php echo base_url();?>index.php/Pdfpst" class="btn btn-primary" style="float:right;"><span class="glyphicon glyphicon-print"></span> Cetak</a>
						</div>
								...
								<div class="col-md-12">
									<table class="table table-hover">
					                  ...
					                  <tbody>
					                    ...
					                    <tr>
					                      <th scope="row"><?php echo $pst->kode_peserta; ?></th>
					                      <td><?php echo $pst->nama; ?></td>
					                      <td><?php echo $pst->kelas; ?></td>
					                      <td><?php echo $pst->sekolah; ?></td>
					                      <td><?php echo $pst->asal_kota; ?></td>
					                      <td>
					                        <a href="<?php echo base_url();?>index.php/Peserta/ubah/<?php echo $pst->kode_peserta;?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
					                        <a href="<?php echo base_url();?>index.php/Peserta/hapus/<?php echo $pst->kode_peserta;?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger">
