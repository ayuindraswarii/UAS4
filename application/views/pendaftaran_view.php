			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?php echo base_url();?>index.php/Pendaftaran" class="active"><i class="lnr lnr-file-empty"></i> <span>Pendaftaran</span></a></li>
								...
								<div class="col-md-12">
									<table class="table table-hover">
					                  ...
					                  <tbody>
					                    ...
					                    <tr>
					                      <th scope="row"><?php echo $pdf->kode_pendaftaran; ?></th>
					                      <td><?php echo $pdf->nama; ?></td>
					                      <td><?php echo $pdf->sekolah; ?></td>
					                      <td><?php echo $pdf->nama_lomba; ?></td>
					                      <td><?php echo $pdf->harga; ?></td>
					                      <td>
					                        <a href="<?php echo base_url();?>index.php/Pendaftaran/ubah/<?php echo $pdf->kode_pendaftaran;?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
					                        <a href="<?php echo base_url();?>index.php/Pendaftaran/hapus/<?php echo $pdf->kode_pendaftaran;?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger">
