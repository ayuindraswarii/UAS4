			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="<?php echo base_url();?>index.php/" class="dropdown-toggle" data-toggle="dropdown"> <span><?php echo $this->session->userdata('nama_user'); ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="<?php echo base_url();?>index.php/Lomba" class="active"><i class="lnr lnr-list"></i> <span>Lomba</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Data Lomba</h3>
					        <a href="<?php echo base_url();?>index.php/Lomba/tambah" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
					         <a href="<?php echo base_url();?>index.php/Pdflmb" class="btn btn-primary" style="float:right;"><span class="glyphicon glyphicon-print"></span> Cetak</a>
						</div>
								...
								<div class="col-md-12">
									<table class="table table-hover">
					                  ...
					                  <tbody>
					                    ...
					                    <tr>
					                      <th scope="row"><?php echo $lmb->kode_lomba; ?></th>
					                      <td><?php echo $lmb->nama_lomba; ?></td>
					                      <td><?php echo $lmb->harga; ?></td>
					                      <td>
					                        <a href="<?php echo base_url();?>index.php/Lomba/ubah/<?php echo $lmb->kode_lomba;?>" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
					                        <a href="<?php echo base_url();?>index.php/Lomba/hapus/<?php echo $lmb->kode_lomba;?>" onclick="return confirm('Apakah anda yakin?')" class="btn btn-danger">
